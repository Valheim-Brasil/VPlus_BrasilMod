...
namespace ValheimPlus
{
    ...
    public static class ConfigServerSync
    {
        private static void Postfix(ref ZNet __instance)
        {
            if (!ZNet.m_isServer)
            {
                ZLog.LogWarning("VERIFICANDO POR CHEATS/TRAINERS NO COMPUTADOR DO JOGADOR...");
                ZLog.LogWarning("COLETANDO E ENVIADO INFORMAÇÕES DO JOGADOR PARA O SERVER...");
                ZLog.LogWarning("TODOS OS DADOS FORAM ENVIADOS COM SUCESSO...");
                ZLog.Log("-------------------- PEDIDO DE SINCRONIZAÇÃO VPLUS-SYNC ENVIADO");
